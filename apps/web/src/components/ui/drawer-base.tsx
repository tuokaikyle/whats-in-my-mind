  ...
  return (
    <DrawerPrimitive.Portal>
      <DrawerPrimitive.Viewport className='pointer-events-none fixed inset-0 z-50'>
        ...
        >
          <DrawerPrimitive.Content data-slot='drawer-content' className='flex h-full flex-col' {...props}>
            {children}
...
function DrawerHeader({ className, ...props }: React.ComponentProps<'div'>) {
  return <div data-slot='drawer-header' className={cn('flex flex-col gap-1.5 border-b p-4', className)} {...props} />;
}
